...
require (
	...
	github.com/dmwm/auth-proxy-server/auth v0.0.0-20260520132256-a22ddbe1dac0
	github.com/dmwm/auth-proxy-server/cric v0.0.0-20260520132256-a22ddbe1dac0
	github.com/dmwm/auth-proxy-server/logging v0.0.0-20260520132256-a22ddbe1dac0
