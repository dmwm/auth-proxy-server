...
require (
	...
	github.com/vkuznet/auth-proxy-server/auth v0.0.0-20210808181353-05338c73b51d
	github.com/vkuznet/auth-proxy-server/cric v0.0.0-20210808175124-b632744d6eae
