...
require (
	...
	github.com/dmwm/auth-proxy-server/auth v0.0.0-20250225125958-72cd38109de4
	github.com/dmwm/auth-proxy-server/cric v0.0.0-20250225125958-72cd38109de4
	github.com/dmwm/auth-proxy-server/logging v0.0.0-20250225125958-72cd38109de4
