...
require (
	...
	github.com/vkuznet/auth-proxy-server/auth v0.0.0-20210928163342-ce66807c684c
	github.com/vkuznet/auth-proxy-server/cric v0.0.0-20210928163342-ce66807c684c
	github.com/vkuznet/auth-proxy-server/logging v0.0.0-20210927161816-74bcf41868fa
